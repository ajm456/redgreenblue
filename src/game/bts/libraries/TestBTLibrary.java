...
//                       DO NOT MODIFY                     
//                                                         
// Generated on 10/07/2016 15:10:48
// ******************************************************* 
package game.bts.libraries;

/**
 * BT library that includes the trees read from the following files:
 * <ul>
 * <li>C:\Users\Andrew\OneDrive\Docs\misc\vn\behaviour_trees\test.xbt</li>
 * </ul>
 */
public class TestBTLibrary implements jbt.execution.core.IBTLibrary {
	/**
	 * Tree generated from file
	 * C:\Users\Andrew\OneDrive\Docs\misc\vn\behaviour_trees\test.xbt.
	 */
	private static jbt.model.core.ModelTask test;

	/* Static initialization of all the trees. */
	static {
		test = new jbt.model.task.decorator.ModelRepeat(null,
				new jbt.model.task.composite.ModelDynamicPriorityList(null,
						new game.bts.model_actions.Shoot(
								new game.bts.model_conditions.PlayerInLineOfSight(
										null)),
						new jbt.model.task.composite.ModelSequence(null,
								...
								new jbt.model.task.decorator.ModelInterrupter(
										null, new game.bts.model_actions.Move(null,
												null, "unitDestination")))));
